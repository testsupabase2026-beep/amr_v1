...
from src.config import SCHEMA_TOP_K
...
from src.export import _generate_summary_fallback
from src.llm import llm
from src.prompts import SQL_FIX_PROMPT, SQL_PROMPT
...
async def _decompose_safe(rewritten: str) -> dict:
    ...
    from src.intent import _decompose_query
